...
public class Quote1DayCurrentManger extends Observable {


    private static Quote1DayCurrentManger quote1DayCurrentManger;

    private String code;


    public static Quote1DayCurrentManger getInstance() {
        if (quote1DayCurrentManger == null) {
            synchronized (Quote1DayCurrentManger.class) {
                if (quote1DayCurrentManger == null) {
                    quote1DayCurrentManger = new Quote1DayCurrentManger();
                }
            }

        }
        return quote1DayCurrentManger;
