...
public class DeviceUtil {
    ...
    public static void openMiuiAppDetails(final Activity activity) {
        ...
        builder.setMessage(activity.getString(com.pro.switchlibrary.R.string.app_name) + "需要访问 \"设备信息\"、\"相册\"、\"地理位置\" 和 \"外部存储器\",请到 \"应用信息 -> 权限\" 中授予！");
    ...
    public static String getHandSetInfo(Context context) {
        ...
        String handSetInfo = "产品型号:" + Build.MODEL
