...
public class Quote1WeekCurrentManger extends Observable {


    private static Quote1WeekCurrentManger quote1WeekCurrentManger;

    private String code;


    public static Quote1WeekCurrentManger getInstance() {
        if (quote1WeekCurrentManger == null) {
            synchronized (Quote1WeekCurrentManger.class) {
                if (quote1WeekCurrentManger == null) {
                    quote1WeekCurrentManger = new Quote1WeekCurrentManger();
                }
            }

        }
        return quote1WeekCurrentManger;
