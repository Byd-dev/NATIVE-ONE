...
public class QuoteWeekCurrentManger extends Observable {


    private static QuoteWeekCurrentManger quoteWeekCurrentManger;

    private String code;


    public static QuoteWeekCurrentManger getInstance() {
        if (quoteWeekCurrentManger == null) {
            synchronized (QuoteWeekCurrentManger.class) {
                if (quoteWeekCurrentManger == null) {
                    quoteWeekCurrentManger = new QuoteWeekCurrentManger();
                }
            }

        }
        return quoteWeekCurrentManger;
