...
public class Quote1MonthHistoryManger extends Observable {


    private static Quote1MonthHistoryManger quote1MonthHistoryManger;

    private String code;
    private int count;


    public static Quote1MonthHistoryManger getInstance() {
        if (quote1MonthHistoryManger == null) {
            synchronized (Quote1MonthHistoryManger.class) {
                if (quote1MonthHistoryManger == null) {
                    quote1MonthHistoryManger = new Quote1MonthHistoryManger();
                }
            }

        }
        return quote1MonthHistoryManger;
        ...
        NetManger.getInstance().getQuoteHistory("http://app.bityard.com", count, "/api/tv/tradingView/history", quote_code, "D", (state, response) -> {
            if (state.equals(BUSY)) {
                ...
                if (quoteChartEntity.getS().equals("ok")) {
                    Log.d("print", "quote:88 "+"1Mon:"+getCount++);
