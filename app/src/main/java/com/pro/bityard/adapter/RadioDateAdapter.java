...
public class RadioDateAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RadioDateAdapter(Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_ITEM) {
            ...
            View view = LayoutInflater.from(context).inflate(R.layout.item_radio_date_layout, parent, false);
