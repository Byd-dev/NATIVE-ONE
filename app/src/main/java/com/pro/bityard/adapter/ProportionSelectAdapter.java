...
public class ProportionSelectAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_ITEM) {
            ...
            View view = LayoutInflater.from(context).inflate(R.layout.item_radio_proportion_layout, parent, false);
    ...
    public interface OnItemClick {
        void onSuccessListener(Integer position, int data);
