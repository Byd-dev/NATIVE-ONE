...
public class OptionalSelectAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public OptionalSelectAdapter(Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_ITEM) {
            ...
            View view = LayoutInflater.from(context).inflate(R.layout.item_radio_optional_layout, parent, false);
