...
public class Quote15MinHistoryManger extends Observable {


    private static Quote15MinHistoryManger quoteHistoryManger;

    private String code;
    private int count;


    public static Quote15MinHistoryManger getInstance() {
        if (quoteHistoryManger == null) {
            synchronized (Quote15MinHistoryManger.class) {
                if (quoteHistoryManger == null) {
                    quoteHistoryManger = new Quote15MinHistoryManger();
                }
            }
    ...
    public void quote(String quote_code, int count) {
        ...
        NetManger.getInstance().getQuoteHistory(NetManger.QUOTE_HISTORY, count, "/api/tv/tradingView/history", quote_code, "15", (state, response) -> {
